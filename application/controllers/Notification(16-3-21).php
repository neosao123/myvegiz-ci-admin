...
class Notification extends CI_Controller
{
	...
	public function sendCommonNotification()
	{
		...
		$random = rand(1, 999);
		if ($clientCode != "") {
			$query = "Select firebaseId from clientmaster where isActive=1 and cityCode in (" . $cityCodes . ") and code='" . $clientCode . "'";
		} else {
			$query = "Select code,firebaseId from clientmaster where isActive=1 and cityCode in (" . $cityCodes . ") limit " . $start . ", " . $end;
		}
