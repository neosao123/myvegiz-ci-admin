...
class GlobalModel1 extends CI_Model{
 ...
 function _construct() {
	  ...
	  function makeQueryCondition1($tables,$requiredColumns,$conditions,$extraConditionColumnNames,$extraConditions,$extraDateConditionColumnNames,$extraDateConditions,$likeFlag)
	  {
		  $query="SELECT ";
		  $colQry="";
		  ...
		  $fromCondition.=$fromExtraCondition;
		  $fromCondition.=" (t0.isDelete IS NULL OR t0.isDelete=0) ORDER BY t0.id ASC ";
		  //echo $query.$colQry.$fromCondition;
		  return $query.$colQry.$fromCondition;
	  }
   ...
   //         }  
	  ...
	  function make_datatables1($tables,$requiredColumns,$conditions,$extraConditionColumnNames,$extraConditions,$extraDateConditionColumnNames=array(),$extraDateConditions=array(),$likeFlag=true){  
           $query=$this->makeQueryCondition1($tables,$requiredColumns,$conditions,$extraConditionColumnNames,$extraConditions,$extraDateConditionColumnNames,$extraDateConditions,$likeFlag);  
   ...
   //         }  
	  ...
	  function make_inwardTable($tables,$requiredColumns,$conditions,$extraConditionColumnNames,$extraConditions,?array $extraDateConditionColumnNames,?array $extraDateConditions,?bool $likeFlag,?string $codeField){  
           $query=$this->makeQueryCondition($tables,$requiredColumns,$conditions,$extraConditionColumnNames,$extraConditions,$extraDateConditionColumnNames,$extraDateConditions,$likeFlag);   
