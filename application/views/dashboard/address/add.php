...
<div class="page-wrapper">
                ...
                <form class="needs-validation" method="post" id="Address" action="<?php echo base_url() . 'Address/save'; ?>" novalidate>
					...
					<div class="form-row">
						...
						<div class="col-md-4 mb-3">                            
							...
							<input type="number" step="any" id="radius" name="radius" class="form-control" required>				
							<div class="invalid-feedback">
                                Required Field !
                            </div>							
                        </div>
 ...
 <script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
    <!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBjAeJLrBzCPACXrH1tuW3JIQUr35t6QaI&callback=initAutocomplete&libraries=places&v=weekly"defer></script>-->
	
	
<script type="text/javascript">
	changeLocator(16.691307,74.244865);
	...
	function changeLocator(lat,lng){
		...
		var map;
		var marker;
		// var latlngChange = new google.maps.LatLng(lat, lng);
		// marker.setPosition(latlngChange);
...
<script>
 ...
 /*
      ...
      // <sscript src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&libraries=places">
