	...
	<div class="page-wrapper">
					...
					<div class="d-flex align-items-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Change In Product Category</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="container-fluid col-md-6">
			...
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Change In Product Category</h4>
					<hr/>
					
					<form class="needs-validation" method="post" id="myForm" enctype="multipart/form-data" action="<?php echo base_url().'index.php/Category/update';?>" novalidate>
												...
												<div class="el-card-avatar el-overlay-1"> <img src="<?php echo base_url().'uploads/category/'.$row->code.'/'.$row->categoryImage;?>" alt="category File">
													<div class="el-overlay">
														<ul class="list-style-none el-info">
															<li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo base_url().'uploads/category/'.$row->code.'/'.$row->categoryImage;?>" target="_blank"><i class="icon-magnifier"></i></a></li>
