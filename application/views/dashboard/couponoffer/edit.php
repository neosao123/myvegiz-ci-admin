		...
		<div class="container-fluid col-md-6">
			...
			<div class="card">
				<div class="card-body">
					...
					<form class="needs-validation" method="post" id="myForm" enctype="multipart/form-data" action="<?php echo base_url().'index.php/Couponoffer/update';?>" novalidate onsubmit="validateFlatAmount()">
						<?php
