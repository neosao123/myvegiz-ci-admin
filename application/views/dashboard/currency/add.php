		...
		<div class="container-fluid col-md-6">
			...
			<div class="card">
				<div class="card-body">
					...
					<form class="needs-validation" method="post" id="myForm" action="<?php echo base_url().'currency/save';?>" novalidate>
						...
						<div class="form-row">
							<div class="col-md-12 mb-3">
								...
								<input type="text" id="currencySName" name="currencySName" class="form-control" onKeyPress="return ValidateAlpha(event);" required>
						...
						<div class="form-row">
							<div class="col-md-12 mb-3">
								...
								<div class="controls">
									...
									<textarea type="text" id="currencyDescription" name="currencyDescription" class="form-control"></textarea>
