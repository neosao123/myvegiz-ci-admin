		...
		<div class="container-fluid col-md-6">
			...
			<div class="card">
				<div class="card-body">
					...
					<hr/>
					<form class="needs-validation" method="post" id=" myForm" action="<?php echo base_url().'index.php/department/save';?>" enctype="multipart/form-data" novalidate>
						...
						<div class="form-row">
							<div class="col-md-12 mb-3">
								...
								<textarea type="text" id="departmentDescription" name="departmentDescription" class="form-control"></textarea>
