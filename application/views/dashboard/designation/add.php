            ...
            <!-- ============================================================== -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="post" id="myForm" action="<?php echo base_url().'index.php/designation/save';?>" novalidate>
                              ...
                              <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label for="designationSName">Designation Short Name : <b style="color:red">*</b></label>
                                        <input type="text" id="designationSName" name="designationSName" class="form-control"  onKeyPress="return ValidateAlpha(event);" required>
                                <!-- <div class="form-control-feedback"><small>Add
                                 <code>required</code> attribute to field for required validation.</small></div> -->
                                    <div class="invalid-feedback">
                                        Required Field !
                                </div>
								</div>
                       ...
                       return true;
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="controls">
                                <textarea id="designationDescription" name="designationDescription" class="form-control" row="2" cols="50" ></textarea>
