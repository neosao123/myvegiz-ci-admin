                ...
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                            ...
                            <div class=""><a class="btn btn-myve" href="<?php echo base_url().'index.php/designation/add';?>">Create Designation</a></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                               ...
                               <div class="table-responsive">
                                    <table id="datatableDesignation" class="table table-striped table-bordered ">
                                        <thead>
                                            <tr>
                                               <th>Sr. No</th>
                                              <th>Code</th>
		...
		<!-- sample modal content -->
			...
			<!-- /.modal -->
					...
					if ($.fn.DataTable.isDataTable("#datatableDesignation")) {
					  $('#datatableDesignation').DataTable().clear().destroy();
					}
							   
							   var dataTable = $('#datatableDesignation').DataTable({  
									stateSave: true,
									"processing":true,  
								   "serverSide":true,  
								   "order":[],
								   "searching": false,
								   "ajax":{  
										url: base_path+"Designation/getDesignationList",  
								  ...
								  "complete": function(response) {
									$(".blue").click(function(){
									 ...
									 $.ajax({
											url: base_path+"Designation/view",  
											method:"GET",
											data:{code:code},
											datatype:"text",
			 ...
			 $('.mywarning').on("click", function() {
				var code=$(this).data('seq');
					...
					swal({
						title: "Are you sure?",
						text: "You want to delete the Designation Record of  "+code,
						type: "warning",
						showCancelButton: !0,
