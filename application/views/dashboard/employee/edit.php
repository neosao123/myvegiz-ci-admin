  ...
  <!--============================================================== -->
                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Change In Employee</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body wizard-content">
                            <h4 class="card-title">Change In Employee</h4>
                            <h6 class="card-subtitle"></h6>
                            <form class="validation-wizard wizard-circle" method="post" enctype="multipart/form-data" id="wizard"> 
								    ...
								    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="code" name="code" value="<?= $row->code?>" readonly> </div>
                                        </div>
									</div>
                                    <div class="row">
										<div class="col-md-1">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control required" id="firstName" name="firstName" value="<?= $row->firstName?>"> </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="middleName">Middle Name :<b style="color:red">*</b></label>
                                                <input type="text" class="form-control required" id="middleName" name="middleName" value="<?= $row->middleName?>"> </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="lastName">Last Name :<b style="color:red">*</b></label>
                                                <input type="text" class="form-control required" id="lastName" name="lastName" value="<?= $row->lastName?>"> </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group" align="center">
                                                ...
                                                <div class="c-inputs-stacked"> 
                                                    ...
                                                    <script>
                                                        ...
                                                        gender == "m" ? $("#male").attr("checked",true) : $("#female").attr("checked",true);
                                                    </script>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group" align="center">
                                                ...
                                                <div class="c-inputs-stacked">
                                                    ...
                                                    <script>
														...
														(maritalStatus == "s" ? $("#single").attr("checked",true) : (maritalStatus == "m" ? $("#married").attr("checked",true) : "unknown"));
                                                    </script>
                                                </div>
                                            </div>
                                        </div>
							  ...
							  <section>
								 ...
								 <div class="form-row">
									<div class="col-md-8 mb-3">
									   ...
									   <input type="text" id="currentAddress" name="currentAddress" class="form-control " placeholder="Max 50 characters allowed.." maxlength="50" value="<?= $row->currentAddress?>">
									</div>
									<div class="col-md-4 mb-3">
									   <label for="currentLandmark">Landmark: </label>
									   <div class="controls">
										  <input type="text" id="currentLandmark" name="currentLandmark" class="form-control" value="<?= $row->currentLandmark?>">
									   </div>
									</div>
								 </div>
								 <div class="form-row">
									<div class="col-md-4 mb-3">
									   ...
									   <div class="input-group">
										  <input type="text" id="currentPlace"  name="currentPlace" list="currentPlaceList" class="form-control" value="<?= $row->currentPlace?>">
									   ...
									   <datalist id="currentPlaceList"></datalist>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="currentPinCode">PinCode: </label>
									   <div class="controls">
										  <input type="number" list="pinCodeList" id="currentPinCode" name="currentPinCode" class="form-control" value="<?= $row->currentPinCode?>">
									   </div>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="currentTaluka">Taluka: </label>
									   <input type="text" id="currentTaluka" list="talukaList" name="currentTaluka" class="form-control" value="<?= $row->currentTaluka?>">
									</div>
								 </div>
								 <div class="form-row">
									<div class="col-md-4 mb-3">
									   ...
									   <div class="controls">
										  <input type="text" id="currentDistrict" list="districtList" name="currentDistrict" class="form-control" value="<?= $row->currentDistrict?>">
									   </div>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="currentState">State: </label>
									   <div class="controls">
										  <input type="text" id="currentState" list="stateList" name="currentState" class="form-control" value="<?= $row->currentState?>">
									   </div>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="currentCountry"> Country: </label>
									   <div class="controls">
										  <input type="text" id="currentCountry" name="currentCountry" class="form-control" value="<?= $row->currentCountry?>">
									   </div>
									</div>
								 </div>
								 <hr/>
								 <div class="form-row">
									...
									<div class="col-sm-5 mb-3">
									   <div class="custom-control custom-checkbox">
										  <?php if($row->isPermanentAddressSame == 1){
											 echo '<input type="checkbox" class="custom-control-input" id="isPermanentAddressSame" value="1" checked>';
											 }else{
											 echo '<input type="checkbox" class="custom-control-input" id="isPermanentAddressSame" value="1" >';
											 }?>
								 ...
								 <div class="form-row">
									<div class="col-md-8 mb-3">
									   ...
									   <input type="text" id="permanentAddress" name="permanentAddress" placeholder="Max 50 characters allowed.." maxlength="50" class="form-control" value="<?= $row->permanentAddress?>" <?=$row->isPermanentAddressSame == 1? readonly : '';?>>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="permanentLandmark">Landmark: </label>
									   <div class="controls">
										  <input type="text" id="permanentLandmark" name="permanentLandmark" class="form-control" value="<?= $row->permanentLandmark?>" <?=$row->isPermanentAddressSame == 1? readonly : '';?>>
									   </div>
									</div>
								 </div>
								 <div class="form-row">
									<div class="col-md-4 mb-3">
									   ...
									   <div class="input-group">
										  <input type="text" id="permanentPlace" list="permanentPlaceList" name="permanentPlace" class="form-control" value="<?= $row->permanentPlace?>">
										  <div class="input-group-append">
									   ...
									   <datalist id="permanentPlaceList"> </datalist>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="permanentPinCode">PinCode: </label>
									   <div class="controls">
										  <input type="number" list="pinCodeList2" id="permanentPinCode" name="permanentPinCode" class="form-control" value="<?= $row->permanentPinCode?>" <?=$row->isPermanentAddressSame == 1? readonly : '';?>>
									   </div>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="permanentTaluka">Taluka: </label>
									   <input type="text" id="permanentTaluka" list="talukaList2" name="permanentTaluka" class="form-control" value="<?= $row->permanentTaluka?>" <?=$row->isPermanentAddressSame == 1? readonly : '';?>>
									</div>
								 </div>
								 <div class="form-row">
									<div class="col-md-4 mb-3">
									   ...
									   <div class="controls">
										  <input type="text" id="permanentDistrict" list="districtList2" name="permanentDistrict" class="form-control" value="<?= $row->permanentDistrict?>" <?=$row->isPermanentAddressSame == 1? readonly : '';?>>
									   </div>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="permanentState">State: </label>
									   <div class="controls">
										  <input type="text" id="permanentState" list="stateList2" name="permanentState" class="form-control" value="<?= $row->permanentState?>" <?=$row->isPermanentAddressSame == 1? readonly : '';?>>
									   </div>
									</div>
									<div class="col-md-4 mb-3">
									   <label for="permanentCountry"> Country: </label>
									   <div class="controls">
										  <input type="text" id="permanentCountry" name="permanentCountry" class="form-control" value="<?= $row->permanentCountry?>" <?=$row->isPermanentAddressSame == 1? readonly : '';?>>
									   </div>
									</div>
								 </div>
							  </section>
                                ...
                                <section>
                                    <div class="form-row">
                                       <div class="col-md-4 mb-3">
                                          ...
                                          <div class="input-group">
                                             <input type="text" id="contact1" onkeypress="return validateFloatKeyPress(this, event, 9, -1);" name="contact1" class="form-control" value="<?= $row->contact1?>" required>
                                             <div class="input-group-append">
                                       ...
                                       <div class="col-md-4 mb-3">
                                          ...
                                          <div class="input-group">
                                             <input type="text" id="contact2" onkeypress="return validateFloatKeyPress(this, event, 9, -1);" name="contact2" class="form-control" value="<?= $row->contact2?>">
                                             <div class="input-group-append">
                                                <span class="input-group-text"><i class="icon-phone"></i></span>
                                             </div>
                                          </div>
                                    ...
                                    <div class="form-row">
                                       <div class="col-md-4 mb-3">
                                          ...
                                          <div class="input-group">
                                             <input type="url" id="fbLink" name="fbLink" class="form-control" value="<?= $row->fbLink?>">
                                             <div class="input-group-append">
                                       ...
                                       <div class="col-md-4 mb-3">
                                          ...
                                          <div class="input-group">
                                             <input type="url" id="linkedInLink" name="linkedInLink" class="form-control" value="<?= $row->linkedInLink?>">
                                             <div class="input-group-append">
                                       ...
                                       <div class="col-md-4 mb-3">
                                          ...
                                          <div class="input-group">
                                             <input type="url" id="gPlusLink" name="gPlusLink" class="form-control" value="<?= $row->gPlusLink?>">
                                             <div class="input-group-append">
                                ...
                                <section>
                                    <div class="row">
									  ...
									  <div class="col-md-4">
                                         <div class="form-group">
                                            ...
                                            <script>
                                                    var employmentStatus = "<?= $row->employmentStatus?>";
									   ...
									   <div class="col-md-4">
                                          ...
                                          <div class="controls">
                                             <input type="text" id="empToken" name="empToken" class="form-control" value="<?= $row->empToken?>">
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <div class="input-group">
                                              <input type="text" class="form-control date-inputmask required" id="joiningDate" name="joiningDate"  >
                                               <?php
												$joiningDateFormat = DateTime::createFromFormat('Y-m-d',$row->joiningDate);
											    $joiningDate = $joiningDateFormat->format('d/m/Y');
												?>
												<script>
                                     ...
                                     <div class="col-md-4">
                                       ...
                                       <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    var salaryGrade = "<?= $row->salaryGrade?>";
                                    ...
                                    <div class="row">
										...
										<div class="col-md-4">
                                            <div class="form-group">
												...
												<script>
                                                    var reportingTo = "<?= $row->reportingTo?>";
                                ...
                                <section>
                                    <div class="form-row">
                                      <div class="col-md-6 mb-3">
                                        ...
                                        <div class="controls">
                                        <input type="text" id="empBankName" name="empBankName" class="form-control" value="<?= $row->empBankName?>">
                                        </div>
                                      </div> 
                                      <div class="col-md-6 mb-3">
                                        <label for="empBankAccountHolderName">Bank Account Holder Name: </label>
                                        <div class="controls">
                                        <input type="text" id="empBankAccountHolderName" name="empBankAccountHolderName" class="form-control" value="<?= $row->empBankAccountHolderName?>">
                                        </div>
                                      </div>    
                                    </div>
                                    <div class="form-row">
                                      <div class="col-md-4 mb-3">
                                        ...
                                        <div class="controls">
                                        <input type="text" id="empBankBranchName" name="empBankBranchName" class="form-control" value="<?= $row->empBankBranchName?>">
                                        </div>
                                      ...
                                      <div class="col-md-4 mb-3">
                                        ...
                                        <div class="controls">
                                        <input type="text" id="empBankIfscCode" name="empBankIfscCode" class="form-control" value="<?= $row->empBankIfscCode?>">
                                        </div>
                                      </div>  
                                      <div class="col-md-4 mb-3">
                                        <label for="empBankMICRCode"> Bank MICR Code: </label>
                                        <div class="controls">
                                        <input type="text" id="empBankMicrCode" name="empBankMicrCode" class="form-control" value="<?= $row->empBankMicrCode?>">
                                        </div>
                                      </div>    
                                    </div>
                                </section>
                                ...
                                <section> 
								 <div class="row">
									<div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" id="empBankAccountNo" name="empBankAccountNo" class="form-control" value="<?= $row->empBankAccountNo?>">
                                        <!-- <div class="form-control-feedback"><small>Add <code></code> attribute to field for  validation.</small></div> -->
                                      </div>
									   <div class="col-md-4 mb-3">
                                        <label for="empAdharNumber">Adhar Card Number: </label>
                                        <input type="aadhar" id="empAdharNumber" name="empAdharNumber" class="form-control" value="<?= $row->empAdharNumber?>">
                                        <!-- <div class="form-control-feedback"><small>Add <code></code> attribute to field for  validation.</small></div> -->
                                      </div>
									   <div class="col-md-4 mb-3">
                                        <label for="empPanNumber">PAN Card Number: </label>
                                        <input type="pan" id="empPanNumber" name="empPanNumber" class="form-control" value="<?= $row->empPanNumber?>">
                                        <!-- <div class="form-control-feedback"><small>Add <code></code> attribute to field for  validation.</small></div> -->
                                      </div>
									   <div class="col-md-4 mb-3">
                                        <label for="empPfAccountNumber">P.F. Account Number: </label>
                                        <input type="text" id="empPfAccountNumber" name="empPfAccountNumber" class="form-control" value="<?= $row->empPfAccountNumber?>">
                                        <!-- <div class="form-control-feedback"><small>Add <code></code> attribute to field for  validation.</small></div> -->
                                      </div>
									  <div class="col-md-4 mb-3">
                                        <label for="empEsiAccountNumber">E.S.I. Account Number: </label>
                                        <input type="text" id="empEsiAccountNumber" name="empEsiAccountNumber" class="form-control" value="<?= $row->empEsiAccountNumber?>">
                                        <!-- <div class="form-control-feedback"><small>Add <code></code> attribute to field for  validation.</small></div> -->
                                      </div>
								 </div>
								 <div class="row">
									<input type="file" id="empBankPassbookFile" name="empBankPassbookFile" class="form-control" style="display:none;">
									<input type="file" id="empAdharFile" name="empAdharFile" class="form-control" style="display:none;" >
									<input type="file" id="empPanFile" name="empPanFile" class="form-control" style="display:none;">
									<input type="file" id="empPfAccountFile" name="empPfAccountFile" class="form-control" style="display:none;">
									<input type="file" id="empEsiAccountFile" name="empEsiAccountFile" class="form-control" style="display:none;">
								 </div>
								  ...
								  <div class="row el-element-overlay">
									  ...
									  <div class="col-md-3 mb-3">
										<div class="card">
											<div class="el-card-item">
												<div class="el-card-avatar el-overlay-1"> <img src="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empBankPassbookFile;?>"  alt="GST File"/>
													<div class="el-overlay">
														<ul class="list-style-none el-info">
															<li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empBankPassbookFile;?>" target="_blank"><i class="icon-magnifier"></i></a></li>
															<li class="el-item"><a class="btn default btn-outline el-link" onclick="buttonClick('empBankPassbookFile')"><i class="icon-pencil"></i></a></li>
														</ul>
													</div>
												</div>
												<div class="el-card-content">
													<h4 class="m-b-0">Bank Passbook File</h4> <!-- <span class="text-muted">Graphics Designer</span> -->
												</div>
											</div>
										</div>
									 </div>
									 <div class="col-md-3 mb-3">
										<div class="card">
											<div class="el-card-item">
												<div class="el-card-avatar el-overlay-1"> <img src="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empAdharFile;?>" alt="GST File"/>
													<div class="el-overlay">
														<ul class="list-style-none el-info">
															<li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empAdharFile;?>" target="_blank"><i class="icon-magnifier"></i></a></li>
															<li class="el-item"><a class="btn default btn-outline el-link" onclick="return buttonClick('empAdharFile')"><i class="icon-pencil"></i></a></li>
														</ul>
													</div>
												</div>
												
												<div class="el-card-content">
													<h4 class="m-b-0">ADHAR Card File</h4> <!-- <span class="text-muted">Graphics Designer</span> -->
												</div>
											</div>
										</div>
									 </div>
									 <div class="col-md-3 mb-3">
										<div class="card">
											<div class="el-card-item">
												<div class="el-card-avatar el-overlay-1"> <img src="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empPanFile;?>" alt="GST File"/>
													<div class="el-overlay">
														<ul class="list-style-none el-info">
															<li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empPanFile;?>" target="_blank"><i class="icon-magnifier"></i></a></li>
															<li class="el-item"><a class="btn default btn-outline el-link" onclick="return buttonClick('empPanFile')"><i class="icon-pencil"></i></a></li>
														</ul>
													</div>
												</div>
												<div class="el-card-content">
													<h4 class="m-b-0">PAN Card File</h4> <!-- <span class="text-muted">Graphics Designer</span> -->
												</div>
											</div>
										</div>
									 </div>
									 <div class="col-md-3 mb-3">
										<div class="card">
											<div class="el-card-item">
												<div class="el-card-avatar el-overlay-1"> <img src="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empPfAccountFile;?>" alt="GST File"/>
													<div class="el-overlay">
														<ul class="list-style-none el-info">
															<li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empPfAccountFile;?>" target="_blank"><i class="icon-magnifier"></i></a></li>
															<li class="el-item"><a class="btn default btn-outline el-link" onclick="return buttonClick('empPfAccountFile')"><i class="icon-pencil"></i></a></li>
														</ul>
													</div>
												</div>
												<div class="el-card-content">
													<h4 class="m-b-0">P.F. Account File</h4> <!-- <span class="text-muted">Graphics Designer</span> -->
												</div>
											</div>
										</div>
									 </div>
									 <div class="col-md-3 mb-3">
										<div class="card">
											<div class="el-card-item">
												<div class="el-card-avatar el-overlay-1"> <img src="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empEsiAccountFile;?>" alt="GST File"/>
													<div class="el-overlay">
														<ul class="list-style-none el-info">
															<li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo base_url().'uploads/employees/'.$row->code.'/'.$row->empEsiAccountFile;?>" target="_blank"><i class="icon-magnifier"></i></a></li>
															<li class="el-item"><a class="btn default btn-outline el-link" onclick="return buttonClick('empEsiAccountFile')"><i class="icon-pencil"></i></a></li>
														</ul>
													</div>
												</div>
												<div class="el-card-content">
													<h4 class="m-b-0">E.S.I Account File</h4> <!-- <span class="text-muted">Graphics Designer</span> -->
												</div>
											</div>
										</div>
									 </div>
	...
	<script>
		function buttonClick(value){
			//alert(value);
			if(value == 'empBankPassbookFile')
			{
				$("#empBankPassbookFile").click();
			}
			if(value == 'empAdharFile')
			{
				$("#empAdharFile").click();
			}
			if(value == 'empPanFile')
			...
			if(value == 'empPfAccountFile')
			{
				$("#empPfAccountFile").click();
			}
			if(value == 'empEsiAccountFile')
			{
				$("#empEsiAccountFile").click();
			}
		}
	</script>
	...
	<script>
		...
		$('document').ready(function(){
			...
			$('#contractCode').change(function(){
				...
				$.ajax({
					url:'<?php echo site_url('entityToDept/getContractFromSite'); ?>',
					method:"GET",
	   ...
	   $.ajax({
		 ...
		 $("#permanentCountry").val(res.country);
                  ...
                  //From Entity Code get Office data from DB
                  $('#entityCode').change(function(){
                      var entity_code = $(this).val();
                      $.ajax({
                               url:'<?php echo site_url('entityToDept/getOfcFromEntity'); ?>',
                               method:"GET",
                               data:{entityCode:entity_code},
                               datatype:"text",
                               success: function(data)
                               {
                  ...
                  //From Office Code get Dept data from DB
                  // $('#officeCode').change(function(){
                      // var office_code = $(this).val();
                      // $.ajax({
                               // url:'<?php echo site_url('entityToDept/getDeptFromOfc'); ?>',
                               // method:"GET",
                               // data:{officeCode:office_code},
                               // datatype:"text",
                               // success: function(data)
                               // {
                                 // $('#deptCode').html(data);
			...
			//Form data except files
				...
				if($("#isPermanentAddressSame").prop("checked") == true){
				 ...
				 var empEsiAccountFile = $("#empEsiAccountFile").prop("files")[0];
                  ...
                  //Form Data Send to employee controller for update
                  $.ajax({
