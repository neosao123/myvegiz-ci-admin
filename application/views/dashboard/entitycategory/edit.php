...
<form method="post" id="updateEntityCategoryForm" enctype="multipart/form-data" novalidate>
<!--action="< ?php echo base_url().'index.php/Vendor/save';?>"-->
	...
	<div class="form-row">
		<div class="col-md-12 mb-3">
			...
			<input type="text" id="entityCategoryName" value="<?=$row->entityCategoryName?>" name="entityCategoryName" class="form-control"  required>
	...
	<div class="text-xs-right">	
		<button type="button" class="btn btn-success" id="updateEntityCategory">Submit</button>
