			...
			<audio id="myAudio" controls style="display:none">
              <source src="https://myvegiz.com/ringing.mp3" type="audio/mp3">
              Your browser does not support the audio element.
            </audio>
			<button type="button" style="display:none" id="button">Click</button>
	
            <script type="text/javascript" src="<?= base_url() . 'assets/admin/assets/extra-libs/maxlength-master/jquery.plugin.js'; ?>"></script>
            <script type="text/javascript" src="<?= base_url() . 'assets/admin/assets/extra-libs/maxlength-master/jquery.maxlength.js'; ?>"></script>
            <!-- Bootstrap tether Core JavaScript -->
            <!--used for ComposeMail-->
            ...
            <script src="<?= base_url() . 'assets/admin/assets/extra-libs/jqbootstrapvalidation/validation.js'; ?>"></script>
            ...
            <script src="<?= base_url() . 'assets/admin/assets/libs/datatables.net-bs4/css/responsive.bootstrap4.min.js' ?>" type="text/javascript"></script>
            <script src="<?= base_url() . 'assets/admin/assets/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js'; ?>"></script>
            <!-- Form Wizard JS -->
            <script src="<?= base_url() . 'assets/admin/assets/libs/jquery-steps/build/jquery.steps.min.js'; ?>"></script>
            <!-- Masked JS -->
            <script src="<?= base_url() . 'assets/admin/assets/libs/inputmask/dist/min/jquery.inputmask.bundle.min.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/dist/js/pages/forms/mask/mask.init.js'; ?>"></script> <!-- PNotify -->
            <script src="<?= base_url() . 'assets/admin/assets/bootstrap-confirm-delete.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/assets/extra-libs/pnotify/dist/pnotify.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/assets/extra-libs/pnotify/dist/pnotify.buttons.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/assets/extra-libs/pnotify/dist/pnotify.nonblock.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/assets/libs/sweetalert2/dist/sweet-alert.min.js'; ?>"></script>
            <!-- tostr alert -->
            <script src="<?= base_url() . 'assets/admin/assets/libs/toastr/build/toastr.min.js'; ?>"></script> <!-- JS For Multiple Select Element-->
            ...
            <!-- JS For Print Pages-->
            <script src="<?= base_url() . 'assets/admin/dist/js/pages/samplepages/jquery.PrintArea.js'; ?>"></script>
            <!--Used for composeMail Page-->
            <script src="<?= base_url() . 'assets/admin/assets/libs/summernote/dist/summernote-bs4.min.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/dist/js/pages/email/email.js'; ?>"></script>
            <!--This page repeaters-->
            <script src="<?= base_url() . 'assets/admin/assets/libs/jquery.repeater/jquery.repeater.min.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/assets/extra-libs/jquery.repeater/repeater-init.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/assets/extra-libs/jquery.repeater/dff.js'; ?>"></script>
            <script src="<?= base_url() . 'assets/admin/assets/extra-libs/num2words/num2words.js'; ?>"></script>
