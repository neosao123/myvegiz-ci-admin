	...
	<div class="page-wrapper">
		...
		<div class="container-fluid col-md-6">
			...
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"> Change In Slider Product</h4>
					<hr/>
					
					<form class="needs-validation" method="post" id="myForm" action="<?php echo base_url().'index.php/Homeslider/update';?>" enctype="multipart/form-data" novalidate>
						<?php foreach($query->result() as $row){?>
							...
							<div class="form-row mb-2"> 								 
								...
								<input type="file" id="imagePath" name="imagePath" class="form-control" accept="image/*"> 
									...
									<div class="col-md-6 mb-3">
										<div class="card">
											<div class="el-card-item">
												<div class="el-card-avatar el-overlay-1"> <img src="<?php echo $path != "" ? $path.'?'.time() : base_url().'assets/admin/assets/images/users/1.jpg';?>" alt="Profile File"/>
													<div class="el-overlay">
														<ul class="list-style-none el-info">
															<li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo $imagePath.'?'.time() != "" ? base_url().'uploads/homeslider/'.$imagePath.'?'.time() : base_url().'assets/admin/assets/images/users/1.jpg';?>" target="_blank"><i class="icon-magnifier"></i></a></li>
												...
												<div class="el-card-content">
													<h4 class="m-b-0">Slider Photo</h4> <!-- <span class="text-muted">Graphics Designer</span> -->
												</div>
												<span>Please upload images of 480 X 320 (with x height) size.</span>
											</div>
										</div>
									</div>
								</div>	
						...
						<div class="text-xs-right">
							...
							<a href="<?= base_url().'index.php/Homeslider/listRecords'?>" class="btn btn-reset" >Back</a>
						</div>						
					</form>
				</div>
			</div>
	...
	<script>
		function deleteButton(code,name){		
			$.ajax({
				 url: base_path+'Homeslider/deleteProductImage',
				 method:"POST",
