            ...
            <!-- <div class="col-md-4"> -->
                <div class="card">
                    <div class="card-body">
                        ...
                        <form  class="needs-validation" method="post" id="myForm" action="<?php echo base_url().'index.php/Jobtype/save';?>" novalidate>
                            

                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label for="jobTypeName">Job Type Name :<b style="color:red">*</b> </label>
                                        <input type="text" id="jobTypeName" name=" jobTypeName" class="form-control" required>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                 <label for="jobTypeDescription">  Job Type Description : </label>
                                    <div class="controls">
                                        <textarea type="text" id="jobTypeDescription" name="jobTypeDescription" class="form-control"></textarea>
