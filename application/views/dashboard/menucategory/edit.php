...
<form method="post" id="updateMenuCategoryForm" enctype="multipart/form-data" novalidate>
<!--action="< ?php echo base_url().'index.php/Vendor/save';?>"-->
	...
	<div class="form-row">
		<div class="col-md-12 mb-3">
			...
			<input type="text" id="menuCategoryName" value="<?=$row->menuCategoryName?>" name="menuCategoryName" class="form-control"  required>
	...
	<div class="form-row">
		<div class="col-md-12 mb-3">
			...
			<input type="number" step="1" id="priority" name="priority" class="form-control" value="<?=$row->priority?>">
			<span class="text-danger" id="err"></span>
		</div>
	</div>
	...
	<div class="text-xs-right">	
		<button type="button" class="btn btn-success" id="updateMenuCategory">Submit</button>
