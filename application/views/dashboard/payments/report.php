   ...
   <div id="load-container" class="container-fluid">
      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <h4 class="card-title"> Payment Generated List</h4>
   ...
   $( document ).ready(function() {
		...
		$("#print").click(function() {
			...
			else
			{
				...
				var year=$('#year').val();
				var date= month+"-"+year;
				var header1=contractName+" PAY LIST FOR "+date;
	...
	function loadDataTable()
	{
		...
		$('#datatablePayments').DataTable({
           ...
           ajax:{  
                url: base_path+"PaymentReports/getPaymentReportList",
				data:{
					//console.log(data);
					'month':month,
					'year':year,
	  ...
	  //get Employee list from contractcode
				    $('#contract').change(function(){
                      ...
                      $.ajax({
                               url:'<?php echo site_url('AttendanceEntry/getemployeeFromContract'); ?>',
                               method:"GET",
