		...
		<div class="page-breadcrumb">
		   <div class="row">
			  <div class="col-5 align-self-center">
				 <h4 class="page-title">RTGS Salary Structure Report</h4>
				 <div class="d-flex align-items-center">
					<nav aria-label="breadcrumb">
					   <ol class="breadcrumb">
						  <li class="breadcrumb-item"><a href="<?php echo base_url().'index.php/admin/index';?>">Home</a></li>
						  <li class="breadcrumb-item active" aria-current="page"> RTGS Salary Structure Report List</li>
					   </ol>
					</nav>
				 </div>
			  </div>
		...
		<div class="container-fluid">
			  ...
			  <div class="col-12">
				 <div class="card">
					<div class="card-body">
					   <div class="card-body">
						  <div class="col-7 align-self-center">
							 <h3 class="card-title"> Generate RTGS Salary Structure Report</h3>
						  </div>
		   ...
		   <div class="row">
			  <div class="col-12">
				 <div class="card">
					<div class="card-body">
					   <h4 class="card-title"> RTGS Report Generated List</h4>
					   ...
					   <div class="table-responsive printableArea">
						  <table id="datatablePayments" class="table table-striped table-bordered" border="1" style="border-collapse:collapse;"  >
							 <thead>
								<tr>
								   <th>Sr. No</th>
								   <th>Employee Name</th>
		...
		$('document').ready(function() {
			...
			$("#print").click(function() {
				...
				else
				{
					...
					var year=$('#year').val();
					var date= month+"-"+year;
					var header1=contractName+" RTGS REPORT FOR "+date;
			...
			if(data!='')
			{
			  ...
			  if(obj.status)
			  {
				 toastr.success(obj.message, 'AttendanceEntry', { "progressBar": true });
		   
			  }
			  else
			  {
				  toastr.error(obj.message, 'AttendanceEntry', { "progressBar": true });
			...
			function loadDataTable()
			{
				...
				$('#datatablePayments').DataTable({
				   ...
				   ajax:{  
						url: base_path+"PaymentReports/getRTGSReportList",
						data:{
