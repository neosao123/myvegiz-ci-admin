            ...
            <!-- <div class="col-md-4"> -->
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="post" id="myForm" action="<?php echo base_url().'index.php/Shift/save';?>" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <!-- <div class="controls"> -->
                                 <input type="time" id="inTime" name="inTime" class="form-control">
						   ...
						   echo "</div>";
                            ...
                            <div class="text-xs-right">
                                <button type="submit"name='s' class="btn btn-info" onclick="page_isPostBack=true;">Submit</button>
