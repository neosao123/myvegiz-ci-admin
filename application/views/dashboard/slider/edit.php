					...
					<div class="d-flex align-items-center"
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">change  Slider</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="container-fluid col-md-6">
			...
			<div class="card">
				<div class="card-body">
					...
					<form class="needs-validation" method="post" id="myForm" action="<?php echo base_url().'index.php/Slider/update';?>" enctype="multipart/form-data" novalidate>
						...
						<div class="text-xs-right">
							...
							<a href="<?= base_url().'index.php/Slider/listRecords'?>" class="btn btn-reset" >Back</a>
						</div>						
					</form>
				</div>
			</div>
	...
	<script>
		function deleteButton(code,name){		
			$.ajax({
				 url: base_path+'Slider/deleteProductImage',
				 method:"POST",
