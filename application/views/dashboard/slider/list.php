                ...
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">                            
                            <div class=""><a class="btn btn-myve" href="<?php echo base_url().'index.php/Slider/add';?>">Create Slider</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"> Filter Slider List</h4>
								<div class="form-row">
									<div class="col-sm-3 mb-3">
										<div class="form-group">
											<span> <label for="cityCode">Slider City:</label> </span>
...
<script>
	$(document).ready(function() {
		...
		$('#btnSearch').on('click', function (e){
			$('#datatableSlider').DataTable().state.clear();
			type=$('#sliderType').val();
		...
		function loadTable(cityCode,type){
			...
			var dataTable = $('#datatableSlider').DataTable({  
				...
				"searching": false,
				"ajax":{  
					url: base_path+"Slider/getSliderList",  
	 ...
	 $( document ).ready(function() {
		...
		if(data!='')
		{
		  ...
		  if(obj.status)
		  {
			 swal('Slider',obj.message,'success');
	   
		  }
		  else
		  {
			  swal('Slider',obj.message,'error');
			 }
		}
		//end show alerts
	});
