	...
	<div class="page-wrapper">
					...
					<div class="d-flex align-items-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Change In Product Subcategory</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="container-fluid col-md-6">
			...
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Change In Product Subcategory</h4>
					<hr/>
					
					<form class="needs-validation" method="post" id="myForm" enctype="multipart/form-data" action="<?php echo base_url().'Subcategory/update';?>" novalidate>
				      <?php foreach($query->result() as $row)
					  {
						...
						<div class="form-row">
							<div class="col-md-12 mb-3">
								<label for="productCategory">Category Name: <b style="color:red">*</b></label>
