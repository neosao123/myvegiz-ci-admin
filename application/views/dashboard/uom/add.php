    ...
    <div class="container-fluid col-md-6">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" id="Uom" action="<?php echo base_url().'Uom/save';?>" novalidate>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
							...
							<input type="text" id="uomName" name="uomName" class="form-control" maxlength="30" required>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <label for="uomSName">UOM Short Name : <b style="color:red">*</b> </label>
							
                            <input type="text" id="uomSName" name="uomSName" class="form-control" onKeyPress="return ValidateAlpha(event);" required>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="controls">
                                <textarea id="uomDescription" name="uomDescription" class="form-control" row="2" cols="50"></textarea>
