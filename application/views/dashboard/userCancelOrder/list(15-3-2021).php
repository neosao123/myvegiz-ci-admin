						...
						<form>
							<div class="form-row">
								...
								<?php	
									...
									$previousDate = date('d/m/Y',strtotime(date() .' - 7 days'));
								?>
								<div class="col-sm-5">
...
<script>
   $( document ).ready(function() { //nitin 05 DEC 2018
	    ...
	    var cityCode,orderCode,orderStatus,pinCode,fromDate,toDate,areaCode,ForListUrls="";
		...
		function dataTable(orderCode,cityCode,areaCode,fromDate,toDate)
		{
