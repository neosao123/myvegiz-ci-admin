<style>
	...
	.select2-container--default .select2-results__option--highlighted[aria-selected],.select2-container--default .select2-results__option[aria-selected=true]  {background:#588002}
    ...
    <div class="container-fluid col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <hr/>                
                <form class="needs-validation" method="post" id="myForm" enctype="multipart/form-data" action="<?php echo base_url() . 'Usermaster/updateProfile'; ?>" novalidate>
                    <?php
                    ...
                    ?>
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
								<label for="empCode ">Code : <b style="color:red">*</b></label>
                        ...
                        <div class="form-row">
						 ...
						 <div class="form-row">
                           <div class="col-md-12 mb-3">
								...
								<input type="text" id="mobilenumber" name="mobilenumber" class="form-control" pattern="[789][0-9]{9}" required value="<?= $row->mobile?>">
								<div class="invalid-feedback">
                        ...
                        <?php
                            if (isset($errormessage)) {
                                echo  "<div class='text-danger text-center' id='errormessage'>".$errormessage."</div>";
                            }
                        ?>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                    ...
                    <div class="text-xs-right">
                        ...
                        <a href="<?php echo base_url() . 'admin'; ?>"><button type="button" class="btn btn-reset">Back</button></a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
	...
	$(document).ready(function(){
	  ...
	  <?php if($this->session->flashdata('response')) { ?>
        var data='<?php echo $this->session->flashdata("response"); ?>';
        if(data!='')
        {
          var obj=JSON.parse(data);
          if(obj.status)
          {
    		  toastr.success(obj.message, 'User Profile', { "progressBar": true }); 
          }
          else
          {
    		  toastr.error(obj.message, 'User Profile', { "progressBar": true }); 
          }
        }
        <?php } ?>
	});
