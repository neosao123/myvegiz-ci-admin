...
.select2-container--default .select2-selection--multiple .select2-selection__choice > span { color:white!important;forn-weight:bold}
	...
	<div class="page-wrapper"> 
					...
					<div class="d-flex align-items-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Create Vendor Item</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="container-fluid col-md-8">
			...
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Create Vendor Item</h4>
					<hr/>
					
					<form class="needs-validation" method="post" id="myForm" enctype="multipart/form-data" action="<?php echo base_url().'index.php/Food/Vendoritem/save';?>" novalidate>
						<?php
							...
							<div class="col-md-5 mb-3">
								...
								<select id="vendorCode" name="vendorCode" class="form-control js-example-responsive" required style="width:100%">
									...
									if($vendormaster){
										...
										{
											echo'<option value="'.$curren->code.'">'.$curren->entityName.'</option>';
										}
									}
									?>
								</select>	
						...
						<div class="form-row">
							...
							<div class="col-md-4 mb-3">
								...
								<input type="number" id="itemPackagingPrice" name="itemPackagingPrice" class="form-control" required>
								<div class="invalid-feedback">
									Required Field!
								</div>
							</div> 
							<div class="col-md-4 mb-3">
								...
								<input type="number" id="maxOrderQty" name="maxOrderQty" class="form-control" required>
								<div class="invalid-feedback">
									Required Field!
								</div>
							</div> 
						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								...
								<select id="menuCategoryCode" name="menuCategoryCode" class="form-control" required>
									...
									if($menucategory)
									{
										foreach($menucategory->result() as $r)
										{
