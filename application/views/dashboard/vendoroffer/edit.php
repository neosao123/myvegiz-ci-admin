	<div class="page-wrapper"> 
		<div class="page-breadcrumb">
			<div class="row">
				<div class="col-12 align-self-center">
					<h4 class="page-title">Vendor Offer</h4>
					<div class="d-flex align-items-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Update Vendor Offer</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="container-fluid col-md-8">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Update Vendor Offer</h4>
					<hr/> 
					<form class="needs-validation" method="post" id="myForm" enctype="multipart/form-data" action="<?php echo base_url().'Food/Offer/update';?>" novalidate onsubmit="validateFlatAmount()">
						<?php
						...
						<div class="form-row">
						    <div class="col-md-12 mb-3">
								...
								<label for="vendorCode">Restaurant:</label>
								<input type="hidden" id="vendorCode" name="vendorCode" value="<?= $r['vendorCode']?>"  readonly>
								<input type="text" id="entityName" name="entityName" value="<?= $r['entityName']?>" readonly class="form-control">
							</div> 
						    ...
						    <div class="col-md-4 mb-3">
								...
								<input type="number" id="perUserLimit" name="perUserLimit" value="<?=$r['perUserLimit']?>" class="form-control" required>
								<div class="invalid-feedback">
									Required Field!
								</div>
							</div> 
						...
						<div class="form-row">
							...
							<div class="col-md-4 mb-3" id="capDiv">
								...
								<input type="number" id="capLimit" value="<?=$r['capLimit']?>" name="capLimit" class="form-control">
								<div class="invalid-feedback">
									Required Field!
								</div>
							</div> 	
							<div class="col-md-4 mb-3 d-none" id="flatAmountDiv">
                                ...
                                <input type="number" id="flatAmount" name="flatAmount" class="form-control" value="<?= $r['flatAmount'] ?>">
                                <div class="invalid-feedback">
                                    Required Field!
                                </div>
                            </div>
						...
						<div class="form-row">
    						<div class="col-md-12 mb-3">
    							...
    							<textarea class="form-control" id="termsAndConditions" name="termsAndConditions" place-holder="Terms and Conditions.."><?= $r['termsAndConditions']?></textarea>
    						</div>
						</div>
						<div class="form-row">
							<div class="col-md-12 mb-3">
								...
								<span> <label> Offer Dates :</label> </span>
									<div class="input-daterange input-group" id="productDateRange">
										<input type="text" class="form-control date-inputmask col-sm-5" name="startDate"  id="startDate" placeholder="dd/mm/yyyy" value="<?= date('d-m-Y',strtotime($r['startDate'])) ?>"required>
										<div class="input-group-append">
										<span class="input-group-text bg-myvegiz b-0 text-white">TO</span>
									  </div>
									<input type="text" class="form-control date-inputmask toDate" name="endDate" id="endDate" placeholder="dd/mm/yyyy" value="<?= date('d-m-Y',strtotime($r['endDate'])) ?>" required>
									</div>
									<div class="invalid-feedback">
										Required Field!
									</div>
						...
						<div class="row">
							...
							<div class="form-group col-md-3">
								<div class="custom-control custom-checkbox mr-sm-2"> 
									...
									<label class="custom-control-label" for="isAdminApproved">  <?= $r['isAdminApproved']==1 ? "Approved" : "Approve ?";?> </label> 
								</div>
							</div>
						</div>
						...
						<div class="text-xs-right">							
							...
							<a href="<?php echo base_url() . 'Food/Offer/listRecords'; ?>">
