...
<body>
    <div class="container">
        <!-- Logo Section -->
        <div class="logo">
            <img src="<?php echo base_url().'assets/images/MYVEGIZ LOGO 3rd-01-cut.png';?>" alt="Myvegiz Logo">
        </div>
        ...
        <ol style="font-size:30px">
            ...
            <li>Select the <strong>My Account</strong> option.</li>
    ...
    <script>
        ...
        var deepLink = 'com.delivery.myvegiz://myvegiz.com/deleteprofile';
