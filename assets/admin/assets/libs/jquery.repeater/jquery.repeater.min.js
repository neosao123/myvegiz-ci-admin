    ...
    ! function(a) {
            ...
            r = function(c) {
                ...
                return e.getType = function() {
                    ...
                    var a, b = e.$().get(0).files || [],
                        c = [];
                    for (a = 0; a < (b.length || 0); a += 1) c.push(b[a].id);
                    return c
                }, e.clear = function() {
                    this.$().each(function() {
                        a(this).wrap("<form>").closest("form").get(0).reset(), a(this).unwrap()
        ...
        return a(this).each(function() {
            ...
            var s = function() {
                    ...
                    return c.$parent ? c.$parent.data("item-id") + "[" + a + "]" : a
                },
                t = function(b) {
                ...
                v = function(b, c, d) {
                    b.each(function(b) {
                        var e = a(this);
                        e.data("item-id", c + "[" + b + "]"), l(e.find("[id]"), d).each(function() {
                            var f = a(this),
                                g = f.attr("id").match(/\[[^\]]+\]/g),
                    ...
                    }), k.find("input[id][checked]").removeAttr("checked").prop("checked", !0)
                };
            ...
            var w = function() {
                    ...
                    return function(b, e) {
                        k.append(b), v(p(), s(), c.repeaters), b.find("[id]").each(function() {
                            a(this).inputClear()
