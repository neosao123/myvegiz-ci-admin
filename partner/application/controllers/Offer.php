...
class Offer extends CI_Controller
{
	...
	public function listRecords()
	{
		...
		$data['coupan'] = $this->GlobalModel->selectQuery('vendoroffer.*', 'vendoroffer',array("vendoroffer.vendorCode" => $addID), array(), array(), array(), array(), '', '', array(), $extraCondition);
		$data['offertype'] = $this->GlobalModel->selectQuery('vendoroffer.*', 'vendoroffer');
		$data['discount'] = $this->GlobalModel->selectQuery('vendoroffer.*', 'vendoroffer',array("vendoroffer.vendorCode" => $addID), array(), array(), array(), array(), '', '', array(), $extraCondition);
	...
	public function getOfferList()
	{
		...
		$condition = array('vendoroffer.vendorCode' => $addID, 'vendoroffer.code' => $coupanCode, 'vendoroffer.offerType' => $offerType, 'vendoroffer.code' => $discountCode, 'vendoroffer.addDate' => $fromDate, 'vendoroffer.addDate' => $toDate);
	...
	public function save()
	{
		...
		if ($result == true) {
			$data = array('error_message' => 'Duplicate Coupon Code');
			$this->load->view('header');
			$this->load->view('offer/add', $data);
			$this->load->view('footer');
		} else {
	...
	public function delete()
	{
		...
		$text = $role . " " . $userName . ' delete Offer Coupon Code "' . $categoryName . '" from ' . $ip;
