		...
		<div class="row">
			...
			<div class="col-7 align-self-center">
				<div class="d-flex no-block justify-content-end align-items-center">
					<div class=""><a class="btn btn-myve" href="<?php echo base_url() . 'Offer/add'; ?>">Create Offer</a></div>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="form-row">
								<div class="col-sm-2 mb-3">
									<div class="form-group">
										<span> <label for="coupanCode">Coupan Code :</label> </span>
										<input type="text" class="form-control" list="coupanlist" id="coupanCode" name="coupanCode" placeholder="Enter coupan Code Here ">
...
<script>
	...
	$(document).ready(function() {
		...
		var coupanCode = "",
			offerType = "",
			discountCode = "", 
			ForListUrls = base_path + "Offer/getOfferList";
