		...
		<div class="container-fluid col-md-8">
			...
			<div class="card">
				<div class="card-body">
					...
					<form class="needs-validation" method="post" id="myForm" enctype="multipart/form-data" action="<?php echo base_url().'index.php/Vendoritem/update';?>" novalidate>
						<?php
						...
						<div class="form-row">
								...
								<!--<div class="col-md-6 mb-3">-->
									<div class="card">
										<div class="el-card-item">
											<div class="el-card-avatar el-overlay-1"> <img id="itemImageShow" src="<?php echo base_url().'uploads/'.$r['vendorCode'].'/vendoritem/'.$r['itemPhoto'];?>" alt="category File">
												<div class="el-overlay">
													<ul class="list-style-none el-info">
														<li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo base_url().'uploads/'.$r['vendorCode'].'/vendoritem/'.$r['itemPhoto'];?>" target="_blank"><i class="icon-magnifier"></i></a></li>
											...
											<div class="el-card-content">
												<h4 class="m-b-0">Item Image</h4> <!-- <span class="text-muted">Graphics Designer</span> -->
											</div>
										</div>
									</div>
								<!--</div>-->
							...
							?> 
								<div class="col-md-12 mb-3">
									<label for="itemImage"> Item Image : <b style="color:red">*</b></label>
						...
						<div class="form-row">
					 		<div class="col-md-12 mb-3">
								<label for="address">Item Description : <b style="color:red">*</b></label>
								<textarea type="text" id="itemDescription" name="itemDescription" class="form-control" required><?= $r['itemDescription']?></textarea>
								<div class="invalid-feedback">
									Required Field!
								</div>
							</div> 
...
<script>
	...
	function deleteButton(codeItem,code,value) {
		// debugger;
		$.ajax({
			url: base_path + 'index.php/Vendoritem/deleteImage',
			method: "POST",
			data: {
				'value': value,
				'code': code,
