	...
	<body>
				...
				<div class="auth-box">
					<div id="loginform">
						<div class="logo">
							...
							<h5 class="font-medium m-b-20">Sign In to Partner</h5>
						</div>
						<!-- Form --> 
						<div class="row">
							<div class="col-12">
								<form class="form-horizontal m-t-20" id="loginform"  action="<?php echo base_url() . 'index.php/Authentication/user_login_process' ?>" name="s" method="post">
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control form-control-lg" id="username" name="username" placeholder="Mobile Number" aria-label="Username" aria-describedby="basic-addon1">
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
		...
		//For Store Credentials
			$(function () {
			  ...
			  if (localStorage.chkboxPart && localStorage.chkboxPart != '') {
				  $('#customCheck1').attr('checked', 'checked');
				  $('#username').val(localStorage.usernamePart);
				  $('#password').val(localStorage.passPart);
			  } else {
				  $('#customCheck1').removeAttr('checked');
				  $('#username').val('');
				  $('#password').val('');
			  ...
			  $('#customCheck1').click(function () {
				  if ($('#customCheck1').is(':checked')) {
					  ...
					  localStorage.usernamePart = $('#username').val();
					  localStorage.passPart = $('#password').val();
					  localStorage.chkboxPart = $('#customCheck1').val();
				  } else {
					  localStorage.usernamePart = '';
					  localStorage.passPart = '';
					  localStorage.chkboxPart = '';
				  }
			  });
			});
		</script>
