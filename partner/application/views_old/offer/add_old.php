	...
	<div class="container-fluid col-md-6">
		<div class="card">
			<div class="card-body">
				...
				<hr/>
				<form class="needs-validation" method="post" id="myForm" enctype="multipart/form-data" action="<?php echo base_url().'index.php/Offer/save';?>" novalidate>
					<?php
					...
					<div class="form-row">
						<div class="col-md-12 mb-3">
							...
							<input type="number" id="amountLimit" name="amountLimit" class="form-control" required>
							<div class="invalid-feedback">
								Required Field!
							</div>
						</div> 						
