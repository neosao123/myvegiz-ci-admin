<div class="page-wrapper">
	...
	<div class="container-fluid col-md-8">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">View Vendor Item</h4>
				<hr/>				
				...
				<div class="row">
					...
					<div class="col-md-4 mb-3">
						...
						<div class="controls">
							<img src="<?php echo base_url().'uploads/'.$row->vendorCode.'/vendoritem/'.$row->itemPhoto;?>" id="entityImageShow" alt="Entity Image" height="120" width="120">
						</div>
					</div>
					<?php } ?> 
				</div>				 
